...
# Updated function with ScrapeOps Proxy
def fetch_and_clean_url(url: str) -> str:
    try:
        proxy_params['url'] = url  # Set the URL in the proxy parameters
...
async def crawl_and_store(url: str, depth: int):
    ...
    async with AsyncWebCrawler() as crawler:
        ...
        for result in results:
            cleaned_text = fetch_and_clean_url(result.url)  # Use fetch_and_clean_url for ScrapeOps
